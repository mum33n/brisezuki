        ...
        <div className="bg-darkBlue">
            <div className="py-20 px-10">
                <div className="w-100 md:w-7/12">
                    ...
                    Zuki Bitgert Academy is a place where people get free education about zero gas fee, Security, DEFI, NFT, and Merit of Bitgert chain over Sol, BSC, ETH including other chains. This is to bring BRC20 to mass adoption.
                    </div>
